      ...
      <Card className="w-full max-w-md overflow-hidden shadow-xl">
        ...
        <CardHeader className="text-center pt-10">
          <div className="relative mx-auto mb-6">
            {/* 배경 글로우 효과 */}
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 rounded-full blur-3xl opacity-20 bg-orange-500 -z-10" />
            ...
            {/* 크레딧 뱃지 */}
            <div className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full bg-yellow-100 dark:bg-yellow-900/50 flex items-center justify-center shadow-md border-2 border-background">
              <Coins className="h-4 w-4 text-yellow-600" />
            </div>
          </div>

          <CardTitle className="text-2xl font-bold">크레딧 구매 오류</CardTitle>
        ...
        <CardContent className="space-y-6 pb-8">
          {/* 에러 메시지 박스 */}
          <div className="p-5 rounded-xl bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-900">
            <p className="text-orange-600 dark:text-orange-400 font-medium text-center">
              크레딧 패키지 정보를 불러올 수 없습니다.
            </p>
          ...
          <div className="space-y-3 pt-2">
            <Button
              onClick={handleRetry}
              disabled={isRetrying}
              className="w-full h-12 text-base font-semibold bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-500/90 hover:to-orange-500/90 text-white shadow-lg"
              size="lg"
            >
              {isRetrying ? (
