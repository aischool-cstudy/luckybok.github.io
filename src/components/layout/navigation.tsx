        ...
        return (
          <li key={link.href}>
            <Link
              ...
              className={cn(
                'text-sm font-medium px-3 py-2 rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2',
                isActive
